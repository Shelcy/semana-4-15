<template>
  <footer id="Contactanos" class="page-footer bg-secondary text-white pt-4">
    <!-- Footer Text -->
    ...
    <div class="footer-copyright text-center py-1 bg-dark">
      <v-btn color="grey" href="https://github.com/Shelcy/semana-4-15" style="font-size= 50px" outlined x-large>
        <v-icon left color="#88E4F" size="50px" >
          mdi-git </v-icon>
      </v-btn>
    </div>
    <!-- Copyright -->
